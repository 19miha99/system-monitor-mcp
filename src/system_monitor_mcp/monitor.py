"""System monitoring tools — CPU, RAM, disk, network, processes, battery, temperatures."""
...
def get_battery_status() -> dict[str, Any]:
    """Get battery status (for laptops): charge percentage, time remaining, power source."""
